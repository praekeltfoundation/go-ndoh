...
var IDENTITY_OPTIONS = {
  ...
  'facility_id': 'File Number',
  'wc_id': 'WC Health Number'
};
...
var GoNDOH = App.extend(function (self) {
  ...
  self.states.add('states:self_opt_in', function (name) {
    return new ChoiceState(name, {
      question: (
        'Welcome to the DOH Pregnancy Registry. Is this no. (' +
        self.im.user.addr + ') ' +
  ...
  self.null_element = function (element) {
    var parent = element.parent();
    var replacement = new libxml.Element(
    ...
    **/
    ...
    var map = {
      ...
      '//*[text()="${givenName}"]': function (element) {
        return self.null_element(element);
      },
      // TODO?
